...
2. Validate the template contract and map fields by actual sheet headers.
3. Write approved analysis values without recalculating semantic judgments.
4. Populate `05_HARA` and derive `06_Safety Goal` from the validated, aggregated Safety Goal records.
